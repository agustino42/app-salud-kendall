...
componentes principales
app/ ├── components/ │ ├ DailyEntry.tsx = Entrada de datos diarios │ ├ HealthAnalysis.tsx = Análisis y visualizaciones │ └── InitialDataForm.tsx = Formulario inicial ├── utils/ │ └── kendall.ts # Cálculos estadísticos └── page.tsx # Página principal
...
Comenzar registro diario
4.2 Registro Diario
Ingresar peso del día
Registrar horas de sueño
Indicar nivel de estrés
Anotar consumo de agua
